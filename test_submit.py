...
from model.u_net import get_unet_512,get_unet_1024,get_unet_1280
...
model.load_weights(filepath='weights/dilation_br_eLU_hq_1280x1920_best_weights.hdf5')
...
df.to_csv('submit/dilation_submission.csv.gz', index=False, compression='gzip')
